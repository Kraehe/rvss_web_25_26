function submitForm(form){
    ...
    let comment = form.email.value;
    alert(name + email + comment)
}


function makeComment(name, comment){const comment_container = document.createElement("div");
    const comment_inner = `<"span class="comment_name${name}"<span/>` `commented /n ${comment}`;
